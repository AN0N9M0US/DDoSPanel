...
"""
    author = r"""
		Ddos Panel By AN0N9M0US
    """
    prints(start_color, end_color, banner)
    prints(end_color, start_color, author)
    print("\n") 
    print(Color.LB+"           ["+Color.LR+"VVIP"+Color.LB+"]"+Color.LC+" AN0N9M0US"+Color.LR+"       ["+Color.LG+"VIP"+Color.LR+"]"+Color.LC+" flood")
    print("\n") 
    print(Color.LR+"           ["+Color.LG+"VIP"+Color.LR+"]"+Color.LC+" gangbang"+Color.LB+"       ["+Color.LR+"VVIP"+Color.LB+"]"+Color.LC+" socket")
    print("\n")
    
    while True:
        cnc = input(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"root"+Color.LB+"@"+Color.LG+"AN0N9M0US"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
        if "gangbang" in cnc:
            try:
        ...
        elif "AN0N9M0US" in cnc:
            try:           
                AN0N9M0US = os.path.join("node_modules/dashdash/etc", "input.py")
                subprocess.run(['python3', AN0N9M0US])
                sys.exit(0)
            except IndexError:
                print('just input AN0N9M0US')
